...
# Install gcc 9.2
GMP_DOWNLOAD_URL=https://gcc.gnu.org/pub/gcc/infrastructure/gmp-6.1.0.tar.bz2
...
MPFR_DOWNLOAD_URL=https://gcc.gnu.org/pub/gcc/infrastructure/mpfr-3.1.4.tar.bz2
...
MPC_DOWNLOAD_URL=https://gcc.gnu.org/pub/gcc/infrastructure/mpc-1.0.3.tar.gz

...
case ${DISTRIBUTION} in
    "rocky8.7") NVIDIA_VERSION="525.105.17"; 
        CUDA_VERSION="12-1"; 
        ...
        ;;
    "rocky8.8") NVIDIA_VERSION="525.105.17"; 
        CUDA_VERSION="12-1"; 
        CUDA_SAMPLES_VERSION="12.1";
        NVIDIA_DRIVER_CHECKSUM="c635a21a282c9b53485f19ebb64a0f4b536a968b94d4d97629e0bc547a58142a";
        NVIDIA_FABRIC_MANAGER_VERSION="525.105.17-1";
...
NVIDIA_FABRIC_MNGR_URL=https://developer.download.nvidia.com/compute/cuda/repos/rhel8/x86_64/nvidia-fabric-manager-${NVIDIA_FABRIC_MANAGER_VERSION}.x86_64.rpm
